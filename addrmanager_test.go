...
func addNaTests() {
	// IPv4
	// Localhost
	addNaTest("127.0.0.1", 23099, "127.0.0.1:23099")
	addNaTest("127.0.0.1", 23100, "127.0.0.1:23100")

	// Class A
	addNaTest("1.0.0.1", 23099, "1.0.0.1:23099")
	addNaTest("2.2.2.2", 23100, "2.2.2.2:23100")
	addNaTest("27.253.252.251", 23101, "27.253.252.251:23101")
	addNaTest("123.3.2.1", 23102, "123.3.2.1:23102")

	// Private Class A
	addNaTest("10.0.0.1", 23099, "10.0.0.1:23099")
	addNaTest("10.1.1.1", 23100, "10.1.1.1:23100")
	addNaTest("10.2.2.2", 23101, "10.2.2.2:23101")
	addNaTest("10.10.10.10", 23102, "10.10.10.10:23102")

	// Class B
	addNaTest("128.0.0.1", 23099, "128.0.0.1:23099")
	addNaTest("129.1.1.1", 23100, "129.1.1.1:23100")
	addNaTest("180.2.2.2", 23101, "180.2.2.2:23101")
	addNaTest("191.10.10.10", 23102, "191.10.10.10:23102")

	// Private Class B
	addNaTest("172.16.0.1", 23099, "172.16.0.1:23099")
	addNaTest("172.16.1.1", 23100, "172.16.1.1:23100")
	addNaTest("172.16.2.2", 23101, "172.16.2.2:23101")
	addNaTest("172.16.172.172", 23102, "172.16.172.172:23102")

	// Class C
	addNaTest("193.0.0.1", 23099, "193.0.0.1:23099")
	addNaTest("200.1.1.1", 23100, "200.1.1.1:23100")
	addNaTest("205.2.2.2", 23101, "205.2.2.2:23101")
	addNaTest("223.10.10.10", 23102, "223.10.10.10:23102")

	// Private Class C
	addNaTest("192.168.0.1", 23099, "192.168.0.1:23099")
	addNaTest("192.168.1.1", 23100, "192.168.1.1:23100")
	addNaTest("192.168.2.2", 23101, "192.168.2.2:23101")
	addNaTest("192.168.192.192", 23102, "192.168.192.192:23102")

	// IPv6
	// Localhost
	addNaTest("::1", 23099, "[::1]:23099")
	addNaTest("fe80::1", 23100, "[fe80::1]:23100")

	// Link-local
	addNaTest("fe80::1:1", 23099, "[fe80::1:1]:23099")
	addNaTest("fe91::2:2", 23100, "[fe91::2:2]:23100")
	addNaTest("fea2::3:3", 23101, "[fea2::3:3]:23101")
	addNaTest("feb3::4:4", 23102, "[feb3::4:4]:23102")

	// Site-local
	addNaTest("fec0::1:1", 23099, "[fec0::1:1]:23099")
	addNaTest("fed1::2:2", 23100, "[fed1::2:2]:23100")
	addNaTest("fee2::3:3", 23101, "[fee2::3:3]:23101")
	addNaTest("fef3::4:4", 23102, "[fef3::4:4]:23102")
}
...
func TestAttempt(t *testing.T) {
	...
	err := n.AddAddressByIP(someIP + ":23099")
	if err != nil {
...
func TestNeedMoreAddresses(t *testing.T) {
	...
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.%d.173.147:23099", i/128+60, i%128+60)
	...
	srcAddr := wire.NewNetAddressIPPort(net.IPv4(173, 144, 173, 111), 23099, 0)
...
func TestGood(t *testing.T) {
	...
	var err error
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.173.147.%d:23099", i/64+60, i%64+60)
		addrs[i], err = n.DeserializeNetAddress(s)
		if err != nil {
			t.Errorf("Failed to turn %s into an address: %v", s, err)
		}
