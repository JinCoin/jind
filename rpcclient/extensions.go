...
//
// NOTE: This is a jinwallet extension.
...
// managed by jinwallet are only written to disk with encrypted private keys,
...
//
// NOTE: This is a jind extension.
func (c *Client) ListAddressTransactionsAsync(addresses []jinutil.Address, account string) FutureListAddressTransactionsResult {
...
//
// NOTE: This is a jinwallet extension.
func (c *Client) ListAddressTransactions(addresses []jinutil.Address, account string) ([]btcjson.ListTransactionsResult, error) {
...
// used by jinwallet to enable a wallet which does not have the private keys
