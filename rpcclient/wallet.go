...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []jinutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []jinutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee jinutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee jinutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address jinutil.Address, amount jinutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address jinutil.Address, amount jinutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address jinutil.Address,
	amount jinutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address jinutil.Address, amount jinutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress jinutil.Address, amount jinutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress jinutil.Address, amount jinutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress jinutil.Address, amount jinutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress jinutil.Address, amount jinutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress jinutil.Address, amount jinutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress jinutil.Address,
	amount jinutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[jinutil.Address]jinutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[jinutil.Address]jinutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[jinutil.Address]jinutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[jinutil.Address]jinutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (jinutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return jinutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []jinutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []jinutil.Address, account string) (jinutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []jinutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []jinutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (jinutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (jinutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (jinutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (jinutil.Address, error) {
...
// Jincoin address for receiving payments to the specified account.
func (r FutureGetAccountAddressResult) Receive() (jinutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
// GetAccountAddress returns the current Jincoin address for receiving payments
// to the specified account.
func (c *Client) GetAccountAddress(account string) (jinutil.Address, error) {
...
func (c *Client) GetAccountAsync(address jinutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address jinutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address jinutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address jinutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]jinutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]jinutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := jinutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]jinutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount jinutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount jinutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount jinutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount jinutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount jinutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount jinutil.Amount,
...
// about the given jincoin address.
...
func (c *Client) ValidateAddressAsync(address jinutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := btcjson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given jincoin address.
func (c *Client) ValidateAddress(address jinutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]jinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]jinutil.Amount)
	for k, v := range accounts {
		amount, err := jinutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]jinutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]jinutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (jinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := jinutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (jinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (jinutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (jinutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (jinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (jinutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (jinutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (jinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (jinutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (jinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address jinutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address jinutil.Address) (jinutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address jinutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address jinutil.Address, minConfirms int) (jinutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address jinutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address jinutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address jinutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address jinutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*jinutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return jinutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address jinutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address jinutil.Address) (*jinutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *jinutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *jinutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *jinutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *jinutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *jinutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *jinutil.WIF, label string, rescan bool) error {
...
// NOTE: While getinfo is implemented here (in wallet.go), a jind chain server
...
// backupwallet (NYI in jinwallet)
// encryptwallet (Won't be supported by jinwallet since it's always encrypted)
// getwalletinfo (NYI in jinwallet or btcjson)
// listaddressgroupings (NYI in jinwallet)
// listreceivedbyaccount (NYI in jinwallet)

// DUMP
// importwallet (NYI in jinwallet)
// dumpwallet (NYI in jinwallet)
