...
/*
Package txscript implements the jincoin transaction script language.

A complete description of the script language used by jincoin can be found at
...
jincoin transaction scripts.

Script Overview

Jincoin transaction scripts are written in a stack-base, FORTH-like language.

The jincoin script language consists of a number of opcodes which fall into
...
The vast majority of Jincoin scripts at the time of this writing are of several
...
what conditions must be met in order to spend jincoins.
