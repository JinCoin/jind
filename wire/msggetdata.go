...
// MsgGetData implements the Message interface and represents a jincoin
...
// NewMsgGetData returns a new jincoin getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new jincoin getdata message that conforms to
