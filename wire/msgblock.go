...
// MsgBlock implements the Message interface and represents a jincoin
...
// BtcDecode decodes from the jincoin wire protocol as it was sent across the
...
// the jincoin wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new jincoin block message that conforms to the
