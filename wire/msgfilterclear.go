...
// MsgFilterClear implements the Message interface and represents a jincoin
...
// NewMsgFilterClear returns a new jincoin filterclear message that conforms to the Message
