...
// MsgInv implements the Message interface and represents a jincoin inv message.
...
// NewMsgInv returns a new jincoin inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new jincoin inv message that conforms to the
