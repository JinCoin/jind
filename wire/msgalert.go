...
// MsgAlert  implements the Message interface and defines a jincoin alert
// message.
//
// This is a signed message that provides notifications that the client should
// display if the signature matches the key.  jincoind/jincoin-qt only checks
...
// NewMsgAlert returns a new jincoin alert message that conforms to the Message
