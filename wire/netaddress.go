...
// maxNetAddressPayload returns the max payload size for a jincoin NetAddress
...
type NetAddress struct {
	...
	// not present in the jincoin version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The jincoin protocol uses a uint32 for the timestamp so it will
