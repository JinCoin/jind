...
// MsgReject implements the Message interface and represents a jincoin reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	...
	// RejectVersion.
	if pver >= RejectVersion {
		// Unfortunately the jincoin protocol does not enforce a sane
...
// NewMsgReject returns a new jincoin reject message that conforms to the
