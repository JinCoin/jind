...
// MsgMemPool implements the Message interface and represents a jincoin mempool
...
// NewMsgMemPool returns a new jincoin pong message that conforms to the Message
