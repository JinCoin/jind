...
// MsgPong implements the Message interface and represents a jincoin pong
// message which is used primarily to confirm that a connection is still valid
// in response to a jincoin ping message (MsgPing).
//
...
// NewMsgPong returns a new jincoin pong message that conforms to the Message
