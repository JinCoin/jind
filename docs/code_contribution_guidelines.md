...
reason, the jind suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire jind
...
One of the major design goals of all core jind packages is to aim for complete
...
commits](https://github.com/JinCoin/jind/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into jind.
...
Rejoice as you will now be listed as a [contributor](https://github.com/JinCoin/jind/graphs/contributors)!
...
[ISC license](https://github.com/JinCoin/jind/blob/master/LICENSE).  This is
the same license as all of the code in the jind suite.
