...
(http://godoc.org/github.com/JinCoin/jind/mempool)

Package mempool provides a policy-enforced pool of unmined jincoin transactions.

A key responsbility of the jincoin network is mining user-generated transactions
...
Since this package does not deal with other jincoin specifics such as network
...
package for any projects needing the ability create an in-memory pool of jincoin
...
```bash
$ go get -u github.com/JinCoin/jind/mempool
```
