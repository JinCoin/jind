...
// a chain server with jind extensions.
...
// standard Jincoin command.  It is an extension for jind.
type DebugLevelCmd struct {
	LevelSpec string
}

// NewDebugLevelCmd returns a new DebugLevelCmd which can be used to issue a
// debuglevel JSON-RPC command.  This command is not a standard Jincoin command.
// It is an extension for jind.
