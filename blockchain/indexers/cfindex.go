...
func storeFilter(dbTx database.Tx, block *jinutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *jinutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *jinutil.Block,
	view *blockchain.UtxoViewpoint) error {
