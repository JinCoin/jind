...
func GetBlockWeight(blk *jinutil.Block) int64 {
...
func GetTransactionWeight(tx *jinutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *jinutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint,
