...
// children nodes.  A diagram depicting how this works for jincoin transactions
...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*jinutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *jinutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *jinutil.Block) error {
