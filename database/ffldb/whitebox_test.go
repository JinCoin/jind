...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*jinutil.Block, error) {
	...
	blocks := make([]*jinutil.Block, 0, 256)
	genesis := jinutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
