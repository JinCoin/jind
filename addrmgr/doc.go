...
/*
Package addrmgr implements concurrency safe Jincoin address manager.

Address Manager Overview

In order maintain the peer-to-peer jincoin network, there needs to be a source
of addresses to connect to as nodes come and go.  The Jincoin protocol provides
