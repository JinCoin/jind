...
var (
	...
	// jincoind encodes a .onion address as a 16 byte number by decoding the
...
// used by jincoin to support Tor (fd87:d87e:eb43::/48).  Note that this range
...
func GroupKey(na *wire.NetAddress) string {
	...
	// jincoind uses /32 for everything, except for Hurricane Electric's
