...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, JIND, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"scriptpubkeyresult-addresses": "The jincoin addresses associated with this script",
	...
	"decodescriptresult-addresses": "The jincoin addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (jind extension)",
	...
	"getcurrentnet--synopsis": "Get jincoin network the server is running on.",
	...
	"infowalletresult-balance":         "The total jincoin balance of the wallet",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in jincoins",
	...
	"searchrawtransactions-address":     "The Jincoin address to search for",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (jind does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown jind.",
	"stop--result0":  "The string 'jind stopping.'",
	...
	"validateaddresschainresult-address": "The jincoin address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "Jincoin address to validate",
	...
	"verifymessage-address":   "The jincoin address to use for the signature",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this jind instance) and when such a transaction first appears in a newly-attached block.",
