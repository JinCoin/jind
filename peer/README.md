...
(http://godoc.org/github.com/JinCoin/jind/peer)

Package peer provides a common base for creating and managing jincoin network
peers.

This package has intentionally been designed so it can be used as a standalone
package for any projects needing a full featured jincoin peer base to build on.
...
```bash
$ go get -u github.com/JinCoin/jind/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/JinCoin/jind/peer#example-package--NewOutboundPeer)  
