...
import (
	...
	rpc "github.com/JinCoin/jind/rpcclient"
	"github.com/JinCoin/jinutil"
)

// nodeConfig contains all the args, and data required to launch a jind process
...
// arguments returns an array of arguments that be used to launch the jind
// process.
...
// command returns the exec.Cmd which will be used to start the jind process.
...
// to the jind process that is launched via Start().
...
// as the base for the log and data directories for jind.
...
// start creates a new jind process, and writes its pid in a file reserved for
...
// stop interrupts the running jind process process, and waits until it exits
...
// shutdown terminates the running jind process, and cleans up all
