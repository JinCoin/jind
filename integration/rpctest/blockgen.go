...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr jinutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*jinutil.Tx, error) {
...
func CreateBlock(prevBlock *jinutil.Block, inclusionTxs []*jinutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr jinutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*jinutil.Block, error) {
	...
	blockTxns := []*jinutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := jinutil.NewBlock(&block)
